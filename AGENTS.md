...
- 2026-07-04: Pushed latest data-backend work to main per direct user request: merged remote API/docs updates, preserved Civitas hero polish, added guided `/ballot` matching flow, and validated Google Civic tests, frontend lint, and Next build.
