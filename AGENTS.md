...
- 2026-07-03: Prepared direct main push per user request: preserved frontend Civitas polish, ballot desktop sizing, Google Civic election guardrails, sourced live-insight validation, Postgres insight payload hashing, and cleaned generated Playwright output from the worktree.
